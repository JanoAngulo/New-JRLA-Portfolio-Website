<template>
  <div class="absolute bg-light dark:bg-dark bottom-0 left-0 grid w-full pb-20 justify-items-center z-[999] dark:text-white">
    <div class="flex items-end justify-between w-full gap-4 px-10 text-base font-semibold tracking-wider sm:justify-center sm:gap-10 lg:px-20">
      <a class="p-0 cursor-pointer hover:text-primary dark:hover:text-secondary" href="#About">About</a>
      <a class="hover:text-primary dark:hover:text-secondary" href="#Features">Features</a>
      <button @click="toggleDarkMode">
        <svg class="h-12 dark:fill-dark-primary fill-light-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 745.03 831.62">
          <g>
            <polygon
            ...
            <path
              ...
              transform="translate(-167.48 -124.19)"></path>
      ...
      <a class="hover:text-primary dark:hover:text-secondary" href="#Works">Works</a>
